...
IMG_HEIGHT = 240
IMG_CHANNELS = 3
INPUT_PATH = 'E:/PyCharm/PRLM_Lab_47138/Datasets/Input/'
OUTPUT_PATH = 'E:/PyCharm/PRLM_Lab_47138/Datasets/UNet_Output/'
# INPUT_PATH = 'C:/Users/eftpr/Pictures/UNET_Rust/input/'
# OUTPUT_PATH = 'C:/Users/eftpr/Pictures/UNET_Rust/output/'
        ...
        if SubcategoryFiles[ImageIdx].endswith(imgFormatType2WorkWithInput):
            ...
            for FileExtensionCheckIdx in range(0, len(imgFormatType2WorkWithOutput)):
                ...
                if tmpFullMaskName is not None:
                    break
            TmpMask = cv2.imread(tmpFullMaskName, 0)
            if TmpMask is None:
