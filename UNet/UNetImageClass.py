...
from UNetDataLoad import IMG_WIDTH, IMG_HEIGHT, IMG_CHANNELS
from UNetDataLoad import X_train, Y_train, X_test, Y_test, X_val, Y_val
...
results = UnetCustMod.fit(X_train, Y_train, batch_size=12, epochs=10, callbacks=callbacksOptions,
                    validation_data=(X_val, Y_val))

#save the final model, once trainng is completed
model_name = 'finalSegCNN_newecl.h5'
