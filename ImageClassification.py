...
def mapFeatureValsToHistogram (DataFeaturesByClass, visualWords, TrainedKmeansModel):
    ...
    for categoryIdx, featureValues in DataFeaturesByClass.items():
        for tmpImageFeatures in featureValues: #yes, we check one by one the values in each image for all images
            ...
            histogramsKmeansList.append(tmpImageHistogram)
            targetClassList.append(categoryIdx)

    return histogramsKmeansList, targetClassList
...
Results = (['FeatureExtraction','Clustering Detection','Train Data ratio',' Classifier Used','Accuracy (tr)','Precision (tr)','Recal(tr)','F1score (tr)',' Accuracy (te)','Precision (te)','Recal(te)','F1 score (te)'],
          ['SIFT','KMeans','80/20','Decision Tree',dtree_acc_train_80_20,dtree_pre_train_80_20,dtree_rec_train_80_20,dtree_f1_train_80_20,dtree_acc_test_80_20,dtree_pre_test_80_20,dtree_rec_test_80_20,dtree_f1_test_80_20],
          ['SIFT','KMeans','80/20','K-NN',knn_acc_train_80_20,knn_pre_train_80_20,knn_rec_train_80_20,knn_f1_train_80_20,knn_acc_test_80_20,knn_pre_test_80_20,knn_rec_test_80_20,knn_f1_test_80_20],
          ['SIFT','KMeans','80/20','GNB',GNB_acc_train_80_20,GNB_pre_train_80_20,GNB_rec_train_80_20,GNB_f1_train_80_20,GNB_acc_test_80_20,GNB_pre_test_80_20,GNB_rec_test_80_20,GNB_f1_test_80_20],
          ['SIFT', 'KMeans', '80/20', 'SVM', SVM_acc_train_80_20, SVM_pre_train_80_20, SVM_rec_train_80_20, SVM_f1_train_80_20, SVM_acc_test_80_20, SVM_pre_test_80_20, SVM_rec_test_80_20, SVM_f1_test_80_20],
          ['SIFT', 'KMeans', '60/40', 'Decision Tree', dtree_acc_train_60_40, dtree_pre_train_60_40,dtree_rec_train_60_40, dtree_f1_train_60_40, dtree_acc_test_60_40, dtree_pre_test_60_40,dtree_rec_test_60_40, dtree_f1_test_60_40],
          ['SIFT', 'KMeans', '60/40', 'K-NN', knn_acc_train_60_40, knn_pre_train_60_40, knn_rec_train_60_40,knn_f1_train_60_40, knn_acc_test_60_40, knn_pre_test_60_40, knn_rec_test_60_40, knn_f1_test_60_40],
          ['SIFT', 'KMeans', '60/40', 'GNB', GNB_acc_train_60_40, GNB_pre_train_60_40, GNB_rec_train_60_40,GNB_f1_train_60_40, GNB_acc_test_60_40, GNB_pre_test_60_40, GNB_rec_test_60_40, GNB_f1_test_60_40],
          ['SIFT', 'KMeans', '60/40', 'SVM', SVM_acc_train_60_40, SVM_pre_train_60_40, SVM_rec_train_60_40,SVM_f1_train_60_40, SVM_acc_test_60_40, SVM_pre_test_60_40, SVM_rec_test_60_40, SVM_f1_test_60_40])
...
workbook = xlsxwriter.Workbook('Results_Classification_SURF.xlsx')
